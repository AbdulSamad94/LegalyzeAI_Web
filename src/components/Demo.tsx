...
const DemoSection = () => {
  ...
  return (
    <>
      ...
      <section
        id="demo"
        className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-600 via-indigo-700 to-purple-800 relative overflow-hidden"
      >
        {/* Background Elements */}
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          <div className="text-center mb-12 animate-fade-in">
            ...
            <p className="text-xl text-blue-100 max-w-3xl mx-auto">
              Experience the power of AI document analysis. Upload any contract,
              NDA, or agreement and get instant insights.
            </p>
          </div>
          ...
          <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl border border-white/20 overflow-hidden animate-fade-in">
            ...
            {(isAnalyzing ||
              ...
              <div className="p-8 animate-fade-in">
                ...
                {/* Structured Results Display (Summary Only) */}
                {structuredData && (
