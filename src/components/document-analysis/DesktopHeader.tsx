      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          >
            ...
            <span className="text-blue-600 font-medium">Document Analysis</span>
          </motion.nav>
            ...
            >
              <div className="py-4 space-y-2">
                ...
                <Link
                  ...
                  className="block w-full text-left px-4 py-3 text-gray-700 hover:bg-gray-50 hover:text-blue-600 transition-colors duration-200 rounded-md font-medium"
                >
                  ← Back to Home
                </Link>

                <div className="px-4 border-b border-gray-200 my-2"></div>
